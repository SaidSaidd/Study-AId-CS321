...
def upload_file():
    ...
    try:
        # Initialize AI features with the uploaded file
        ...
        # Generate questions
        num_questions = 5  # You can adjust this
        ...
        # Clean up uploaded files in Gemini
        ...
        doc_ref = db.collection('chats').add(chat_data)[1]  # Returns tuple (timestamp, doc_ref)
        chat_id = doc_ref.id
